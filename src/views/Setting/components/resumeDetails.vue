  ...
  <div>
    ...
    <div class="card" style="display: flex">
              ...
              <el-col :span="18">
                <div class="text">
                  ...
                  <div class="text-one">
                    ...
                    <span class="resumeList">{{ resumeList.age }}岁</span>
          ...
          <div class="job" style="border: 0">
            ...
            <div v-for="item in certification" :key="item.id">
              <el-row class="qualification">
                ...
                <el-col :span="10" style="font-weight: 800; line-height: 100px"
      ...
      <div class="Btn">
        <el-button
          v-if="numList"
          style="background-color: rgb(37, 110, 253); color: #fff"
          @click="downItem"
          ><Item icon="xiazai" />下载简历</el-button
        >
        <el-button
          v-if="!state"
          style="background-color: rgb(37, 110, 253); color: #fff; width: 110px"
          icon="el-icon-star-off"
          @click="like(resumeList.id)"
          >收藏</el-button
        >
        <el-button
          v-if="state"
          style="background-color: rgb(37, 110, 253); color: #fff; width: 110px"
          icon="el-icon-star-off"
          @click="changeDelte(resumeList.id)"
          >已收藏</el-button
        >
      </div>
    </div>
...
import { getJob, getLike, getwork, getExperiences, getProject, getCertification, getResume } from '@/api/setting/index'
import { getIntroduction } from '@/api/firm'
import Item from '@/layout/components/Sidebar/Item'
import axios from 'axios'
import { getLikes } from '@/api/information/index'
...
export default {
  ...
  methods: {
    async num () {
      ...
      console.log('状态', res)
      if (this.resumeList.is_collected) {
        this.state = true
      } else {
        this.state = false
      }
